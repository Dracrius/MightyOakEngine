...
{
    PhysicsWorldBullet* btWorld = static_cast<PhysicsWorldBullet*>(world->getWorldUserInfo());
...
void PhysicsWorldBullet::CreateSensor(GameObject* owner, TransformComponent* pTransform, bool hasCollision)
{
    vec3 pos = pTransform->GetPosition();
    vec3 rot = pTransform->GetRotation();
    ...
    //m_pWorld->setInternalTickCallback(TickCallback, this, true);
}
