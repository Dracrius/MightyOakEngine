...
{   
    ...
    { vec3(-1.0f,1.0f,-1.f),  255,255,255,255,      vec2(0.f,       1.f) }, // Point 6
    //Side 2
    ...
    { vec3(1.0f,1.0f,1.f),  255,255,255,255,        vec2(2.f / 6.f, 1.f) }, // Point 5
    ...
    { vec3(1.0f,-1.0f,1.f),  255,255,255,255,       vec2(2.f / 6.f, 0.f) }, // Point 5
    { vec3(-1.0f,-1.0f,1.f),  255,255,255,255,      vec2(3.f / 6.f, 0.f) }, // Point 6
    //Side 4
    ...
    { vec3(-1.0f,-1.0f,-1.f),  255,255,255,255,     vec2(3.f / 6.f, 1.f) }, // Point 6
    //Side 5
    ...
    { vec3(-1.0f,1.0f,-1.f),  255,255,255,255,      vec2(1.f,       1.f) }, // Point 5
